...
import com.example.weddingplanner.databinding.FragmentHomeDecBinding
...
class HomeDecFragment : Fragment(), CategoryListener {
    private var _binding : FragmentHomeDecBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentHomeDecBinding.inflate(inflater, container, false)
